...
function useGetPlanPricings() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (!actor) return [];
      try {
        return await actor.getPlanPricings();
      } catch {
        return [];
      }
    },
...
function useAdminGetAllPlanPricings() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (!actor) return [];
      try {
        return await actor.adminGetAllPlanPricings();
      } catch {
        return [];
      }
    },
...
function useAdminGetPendingSubRequests() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (!actor) return [];
      try {
        return await actor.adminGetPendingSubRequests();
      } catch {
        return [];
      }
    },
...
function useAdminGetAllSubRequests() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (!actor) return [];
      try {
        return await actor.adminGetAllSubRequests();
      } catch {
        return [];
      }
    },
...
function useAdminGetSubRequestEarnings() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (!actor) return [0, 0, 0n];
      try {
        return await actor.adminGetSubRequestEarnings();
      } catch {
        return [0, 0, 0n];
      }
    },
...
export {
  ...
  useFocusGuards as J,
  FocusScope as K,
  DismissableLayer as L,
  createContext2 as M,
  useGetMyCustomerProfile as N,
  useSavePushSubscription as O,
  Presence as P,
  LogOut as Q,
  ...
  TabsTrigger as U,
  TabsContent as V,
  useSaveCustomerProfile as W,
  useGetAllActiveSalons as X,
  useGetMyAppointments as Y,
  useGetSalonServices as Z,
  useBookAppointment as _,
  useAdminGetPendingSalons as a,
  useLayoutEffect2 as a0,
  useCallbackRef$1 as a1,
  useDirection as a2,
  createCollection as a3,
  useGetCurrentServiceSession as a4,
  useGetQueueScheduleForSalon as a5,
  useGetPendingNotifications as a6,
  useStartServiceSession as a7,
  useClearServiceSession as a8,
  useMarkNotificationSent as a9,
  useGetPlanPricings as aa,
  useSubmitSubscriptionRequest as ab,
  useGetMySalon as ac,
  useGetSalonAppointmentsForDate as ad,
  useGetOwnerRevenueSummary as ae,
  useUpdateAppointmentStatus as af,
  useAddSalonService as ag,
  useDeleteSalonService as ah,
  useUpdateMySalon as ai,
  ...
  useAdminExpireOldSubRequests as y,
  useAdminApproveSubRequest as z
};
