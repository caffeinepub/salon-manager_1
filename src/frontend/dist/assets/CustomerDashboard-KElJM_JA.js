import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, a as useComposedRefs, b as cn, d as useActor, S as Scissors, B as Button, E as ErrorBoundary, u as ue, L as Label, I as Input, e as LoaderCircle, f as SalonLoadingScreen, P as Phone } from "./index-CbYqk_CC.js";
import { F as useControllableState, G as useId, P as Presence, H as Primitive, I as composeEventHandlers, J as Portal$1, K as hideOthers, L as createContextScope, R as ReactRemoveScroll, M as useFocusGuards, N as FocusScope, O as DismissableLayer, Q as createSlot, S as createContext2, X, T as useGetMyCustomerProfile, U as useSavePushSubscription, V as LogOut, W as Tabs, Y as TabsList, Z as TabsTrigger, _ as TabsContent, $ as useSaveCustomerProfile, C as Card, o as CardHeader, p as CardTitle, n as CardContent, a0 as useGetAllActiveSalons, a1 as Navigation, B as Badge, a2 as useGetMyAppointments, a3 as useGetSalonServices, a4 as useGetSalonClosedDays, a5 as useBookAppointment, a6 as useGetQueueInfo, a7 as useGetSalonPhotos } from "./tabs-B_fgeGBU.js";
import { C as CircleCheckBig, a as Clock } from "./clock-xWT7Pku1.js";
/**
...
function SalonListTab({
  ...
  const [ratingFilter, setRatingFilter] = reactExports.useState(0);
  const [serviceFilter, setServiceFilter] = reactExports.useState("");
  const [userLocation, setUserLocation] = reactExports.useState(null);
  const [nearbyActive, setNearbyActive] = reactExports.useState(false);
  ...
  const handleNearbyToggle = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      (pos) => {
        ...
        setGpsLoading(false);
        ue.success("📍 Location मिल गई! पास के सैलून दिखाए जा रहे हैं");
      },
      () => {
        setGpsLoading(false);
  ...
  const hasAnyFilter = searchText.trim() !== "" || ratingFilter > 0 || serviceFilter !== "" || nearbyActive;
  let filtered = salons.map((s) => {
    const distKm = userLocation && s.latitude != null && s.longitude != null ? haversineKm(
      userLocation.lat,
      userLocation.lng,
      s.latitude,
      s.longitude
  ...
  if (nearbyActive && userLocation) {
    filtered = filtered.filter((s) => s.distKm !== void 0).sort((a, b) => (a.distKm ?? 9999) - (b.distKm ?? 9999));
  }
  if (isLoading) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
          ...
          style: {
            ...
            color: "oklch(0.97 0.015 80)",
            paddingRight: searchText ? "2.5rem" : void 0
          }
        }
      ),
      searchText && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-4 h-4", style: { color: "oklch(0.55 0.04 80)" } })
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 overflow-x-auto pb-1 no-scrollbar", children: [
      RATING_FILTERS.map((rf) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          ...
          style: {
            background: ratingFilter === rf.value ? "oklch(0.78 0.12 80)" : "oklch(0.17 0.012 60)",
            color: ratingFilter === rf.value ? "oklch(0.09 0.005 60)" : "oklch(0.65 0.07 80)",
            border: ratingFilter === rf.value ? "1px solid oklch(0.78 0.12 80)" : "1px solid oklch(0.28 0.04 75 / 0.6)",
      ...
      COMMON_SERVICES.map((svc) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          ...
          className: "flex-shrink-0 text-xs px-3 py-1.5 rounded-full transition-all",
          style: {
            background: serviceFilter === svc ? "oklch(0.78 0.12 80)" : "oklch(0.17 0.012 60)",
            color: serviceFilter === svc ? "oklch(0.09 0.005 60)" : "oklch(0.65 0.07 80)",
            border: serviceFilter === svc ? "1px solid oklch(0.78 0.12 80)" : "1px solid oklch(0.28 0.04 75 / 0.6)",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          style: {
            background: nearbyActive ? "oklch(0.78 0.12 80)" : "oklch(0.17 0.012 60)",
            color: nearbyActive ? "oklch(0.09 0.005 60)" : "oklch(0.65 0.07 80)",
            border: nearbyActive ? "1px solid oklch(0.78 0.12 80)" : "1px solid oklch(0.28 0.04 75 / 0.6)",
            fontWeight: nearbyActive ? 700 : 400
          },
          children: [
            gpsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-3 h-3 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, { className: "w-3 h-3" }),
            "पास के सैलून"
          ]
        }
      )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h2",
        {
          ...
          style: { color: "oklch(0.97 0.015 80)" },
          children: hasAnyFilter ? `${filtered.length} सैलून मिले` : `सभी सैलून (${salons.length})`
        }
      ),
      hasAnyFilter && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          onClick: () => {
    ...
    serviceFilter && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          '💡 "',
          serviceFilter,
          '" वाले सैलून देखने के लिए सैलून खोलकर सेवाएं चेक करें'
        ]
      }
    ),
    filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12", "data-ocid": "salons.empty_state", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Scissors,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "oklch(0.55 0.04 80)" }, children: hasAnyFilter ? "कोई सैलून नहीं मिला" : "अभी कोई सैलून उपलब्ध नहीं" }),
      hasAnyFilter && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1", style: { color: "oklch(0.4 0.03 70)" }, children: "फ़िल्टर बदलकर दोबारा कोशिश करें" })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                  ...
                  nearbyActive && salon.distKm !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Badge,
                    {
                      className: "text-xs px-1.5 py-0",
                      style: {
...
function BookingModal({
  ...
  const [closedDayMsg, setClosedDayMsg] = reactExports.useState("");
  ...
  const handleDateChange = (e) => {
    ...
    if (val && isClosedDay(val)) {
      const dayIdx = (/* @__PURE__ */ new Date(`${val}T00:00:00`)).getDay();
      const dayNames = [
        "रविवार",
        "सोमवार",
        "मंगलवार",
  ...
  const handleBook = () => {
    ...
    if (isClosedDay(date)) {
      const dayIdx = (/* @__PURE__ */ new Date(`${date}T00:00:00`)).getDay();
      const dayNames = [
        "रविवार",
        "सोमवार",
        "मंगलवार",
      ...
      ue.error(`यह सैलून ${dayNames[dayIdx]} को बंद रहता है`);
      return;
    }
    if (!selectedService) {
      ue.error("सेवा चुनें");
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                ...
                style: {
                  background: "oklch(0.17 0.012 60)",
                  border: closedDayMsg ? "1px solid oklch(0.577 0.245 27.325)" : "1px solid oklch(0.32 0.06 78 / 0.5)",
                  color: "oklch(0.97 0.015 80)"
                }
              }
            ),
            closedDayMsg && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
