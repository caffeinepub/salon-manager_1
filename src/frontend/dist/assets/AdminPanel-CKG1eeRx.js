        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              style: {
                background: subTab === "pending" ? "oklch(0.78 0.12 80)" : "oklch(0.17 0.012 60)",
                color: subTab === "pending" ? "oklch(0.09 0.005 60)" : "oklch(0.55 0.04 80)"
              },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              style: {
                background: subTab === "history" ? "oklch(0.78 0.12 80)" : "oklch(0.17 0.012 60)",
                color: subTab === "history" ? "oklch(0.09 0.005 60)" : "oklch(0.55 0.04 80)",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              onClick: () => {
                ...
                ue.info(`${salon.name} के लिए ट्रायल ${d} दिन सेट करें`);
              },
              children: "सेव"
            }
          )
