...
import { n as Subscribable, s as shallowEqualObjects, o as hashKey, p as getDefaultState, q as notifyManager, t as useQueryClient, r as reactExports, v as noop, w as shouldThrowError, c as createLucideIcon, j as jsxRuntimeExports, x as Slot, b as cn, y as cva, d as useActor, z as useQuery, u as ue, A as React, C as composeRefs, g as reactDomExports, a as useComposedRefs, D as ReactDOM, R as React2 } from "./index-CbYqk_CC.js";
...
function getAdminHash() {
  return typeof window !== "undefined" ? localStorage.getItem("salon360_admin_hash") ?? "" : "";
}
function useAdminGetDashboardStats() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return actor.adminGetDashboardStats(ADMIN_EMAIL, getAdminHash());
    },
...
function useAdminSetSubscriptionPrice() {
  ...
  return useMutation({
    mutationFn: async (price) => {
      ...
      return actor.adminSetSubscriptionPrice(
        ADMIN_EMAIL,
        getAdminHash(),
        price
      );
...
function useAdminGetAllSalons() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (!actor) return [];
      return actor.adminGetAllSalons(ADMIN_EMAIL, getAdminHash());
    },
    enabled: !!actor && !isFetching
  });
}
function useAdminGetPendingSalons() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (!actor) return [];
      return actor.adminGetPendingSalons(ADMIN_EMAIL, getAdminHash());
    },
    enabled: !!actor && !isFetching,
    refetchInterval: 3e4
  });
...
function useAdminApproveSalon() {
  ...
  return useMutation({
    mutationFn: async (salonId) => {
      if (!actor) throw new Error("No actor");
      return actor.adminApproveSalon(
        ADMIN_EMAIL,
        getAdminHash(),
        salonId
      );
...
function useAdminResetOwnerPassword() {
  const { actor } = useActor();
  return useMutation({
    mutationFn: async ({
      ownerPhone,
      ...
      if (!actor) throw new Error("No actor");
      return actor.adminResetOwnerPassword(
        ADMIN_EMAIL,
        getAdminHash(),
        ownerPhone,
        newPasswordHash
...
function useAdminSetSalonSubscription() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      if (!actor) throw new Error("No actor");
      return actor.adminSetSalonSubscription(
        ADMIN_EMAIL,
        getAdminHash(),
        salonId,
        active
...
function useAdminSetSalonActive() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      if (!actor) throw new Error("No actor");
      return actor.adminSetSalonActive(
        ADMIN_EMAIL,
        getAdminHash(),
        salonId,
        active
...
function useAdminSetDefaultTrialDays() {
  ...
  return useMutation({
    mutationFn: async (days) => {
      if (!actor) throw new Error("No actor");
      return actor.adminSetDefaultTrialDays(
        ADMIN_EMAIL,
        getAdminHash(),
        BigInt(days)
      );
...
function useAdminSetSalonTrialDays() {
  const { actor } = useActor();
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async ({
      ...
      return actor.adminSetSalonTrialDays(
        ADMIN_EMAIL,
        adminHash,
        salonId,
        days
...
function useAdminGetRevenueStats() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (!actor) throw new Error("No actor");
      return actor.adminGetRevenueStats(ADMIN_EMAIL, getAdminHash());
    },
    enabled: !!actor && !isFetching,
    refetchInterval: 6e4
  });
  ...
  return useMutation({
    mutationFn: async () => {
      ...
      const [salons, services, appointments, customers, ownerMap, nextIds] = await Promise.all([
        actor.adminGetAllSalonsForBackup(ADMIN_EMAIL, adminHash),
        actor.adminGetAllServicesForBackup(ADMIN_EMAIL, adminHash),
        actor.adminGetAllAppointmentsForBackup(
          ADMIN_EMAIL,
          adminHash
        ),
        actor.adminGetAllCustomersForBackup(ADMIN_EMAIL, adminHash),
        actor.adminGetOwnerPhoneMapForBackup(ADMIN_EMAIL, adminHash),
        actor.adminGetNextIdsForBackup(ADMIN_EMAIL, adminHash)
      ]);
...
function useStartServiceSession(ownerPhone) {
  const { actor } = useActor();
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async ({
...
function useGetCurrentServiceSession(salonId) {
  const { actor, isFetching } = useActor();
  return useQuery({
    queryKey: ["serviceSession", salonId == null ? void 0 : salonId.toString()],
    queryFn: async () => {
...
function useGetQueueScheduleForSalon(salonId, date) {
  const { actor, isFetching } = useActor();
  return useQuery({
    queryKey: ["queueSchedule", salonId == null ? void 0 : salonId.toString(), date],
    queryFn: async () => {
      if (!actor || !salonId) return [];
...
function useGetPendingNotifications(salonId, date) {
  const { actor, isFetching } = useActor();
  return useQuery({
    queryKey: ["pendingNotifications", salonId == null ? void 0 : salonId.toString(), date],
    queryFn: async () => {
      if (!actor || !salonId) return [];
...
function useMarkNotificationSent(ownerPhone) {
  const { actor } = useActor();
  const qc = useQueryClient();
  return useMutation({
...
function useSavePushSubscription() {
  const { actor } = useActor();
  return useMutation({
    mutationFn: async ({
      phone,
...
function useClearServiceSession(ownerPhone) {
  const { actor } = useActor();
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async () => {
...
function useGetPlanPricings() {
  const { actor, isFetching } = useActor();
  return useQuery({
    queryKey: ["planPricings"],
    queryFn: async () => {
      if (!actor) throw new Error("Backend se connection nahi");
      return actor.getPlanPricings();
    },
    enabled: !!actor && !isFetching
  });
}
function useAdminGetAllPlanPricings() {
  const { actor, isFetching } = useActor();
  return useQuery({
    ...
    queryFn: async () => {
      if (!actor) throw new Error("Backend se connection nahi");
      const adminHash = getAdminHash();
      return actor.adminGetAllPlanPricings(ADMIN_EMAIL, adminHash);
    },
    enabled: !!actor && !isFetching
  });
}
function useAdminSetPlanPricing() {
  const { actor } = useActor();
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async ({
      ...
      if (!actor) throw new Error("No actor");
      const adminHash = getAdminHash();
      return actor.adminSetPlanPricing(
        ADMIN_EMAIL,
        adminHash,
        planName,
        originalPrice,
...
function useSubmitSubscriptionRequest() {
  const { actor } = useActor();
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async (params) => {
      if (!actor) throw new Error("Backend se connection nahi। पेज reload करें।");
      return actor.submitSubscriptionRequest(
        params.ownerPhone,
        params.salonName,
        params.planName,
...
function useAdminGetPendingSubRequests() {
  const { actor, isFetching } = useActor();
  return useQuery({
    queryKey: ["adminPendingSubRequests"],
    queryFn: async () => {
      if (!actor) throw new Error("Backend se connection nahi");
      return actor.adminGetPendingSubRequests(
        ADMIN_EMAIL,
        getAdminHash()
      );
    },
...
function useAdminGetAllSubRequests() {
  const { actor, isFetching } = useActor();
  return useQuery({
    queryKey: ["adminAllSubRequests"],
    queryFn: async () => {
      if (!actor) throw new Error("Backend se connection nahi");
      return actor.adminGetAllSubRequests(ADMIN_EMAIL, getAdminHash());
    },
    enabled: !!actor && !isFetching,
    refetchInterval: 1e4
  });
}
function useAdminApproveSubRequest() {
  const { actor } = useActor();
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async (requestId) => {
      if (!actor) throw new Error("No actor");
      return actor.adminApproveSubRequest(
        ADMIN_EMAIL,
        getAdminHash(),
        requestId
      );
...
function useAdminRejectSubRequest() {
  const { actor } = useActor();
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async (requestId) => {
      if (!actor) throw new Error("No actor");
      return actor.adminRejectSubRequest(
        ADMIN_EMAIL,
        getAdminHash(),
        requestId
      );
...
function useAdminGetSubRequestEarnings() {
  const { actor, isFetching } = useActor();
  return useQuery({
    queryKey: ["adminSubEarnings"],
    queryFn: async () => {
      if (!actor) throw new Error("Backend se connection nahi");
      return actor.adminGetSubRequestEarnings(
        ADMIN_EMAIL,
        getAdminHash()
      );
    },
...
function useAdminExpireOldSubRequests() {
  const { actor } = useActor();
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async () => {
      if (!actor) throw new Error("No actor");
      return actor.adminExpireOldSubRequests(
        ADMIN_EMAIL,
        getAdminHash()
      );
    },
...
function useAdminGetSubHistory() {
  const { actor, isFetching } = useActor();
  return useQuery({
    ...
    queryFn: async () => {
      if (!actor) throw new Error("Backend se connection nahi");
      const adminHash = getAdminHash();
      return actor.adminGetSubHistory(
        ADMIN_EMAIL,
        adminHash
      );
    },
...
function useGetMySubHistory(ownerPhone) {
  const { actor, isFetching } = useActor();
  return useQuery({
    queryKey: ["mySubHistory", ownerPhone],
    queryFn: async () => {
      if (!actor || !ownerPhone) throw new Error("Phone ya actor missing hai");
      return actor.getMySubHistory(ownerPhone);
    },
    enabled: !!actor && !isFetching && !!ownerPhone
  });
}
function useGetSalonPhotos(salonId) {
  const { actor, isFetching } = useActor();
  return useQuery({
    queryKey: ["salonPhotos", salonId == null ? void 0 : salonId.toString()],
    queryFn: async () => {
      if (!actor || !salonId) return [];
      const result = await actor.getSalonPhotos(salonId);
      return result ?? [];
    },
    enabled: !!actor && !isFetching && !!salonId,
    staleTime: 2 * 60 * 1e3
...
function useUploadSalonPhoto(ownerPhone) {
  const { actor } = useActor();
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async ({
...
function useDeleteSalonPhoto(ownerPhone) {
  const { actor } = useActor();
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async ({
...
function useGetSalonClosedDays(salonId) {
  const { actor, isFetching } = useActor();
  return useQuery({
    queryKey: ["salonClosedDays", salonId == null ? void 0 : salonId.toString()],
    queryFn: async () => {
      if (!actor || !salonId) return Array(7).fill(false);
      try {
        const result = await actor.getSalonClosedDays(salonId);
...
function useSetSalonClosedDays(ownerPhone) {
  const { actor } = useActor();
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async ({
      ...
      if (!actor) throw new Error("Backend se connection nahi। पेज reload करें।");
      return actor.setSalonClosedDays(
        ownerPhone,
        passwordHash,
        closedDays
      );
...
function useUpdateSalonLocation(ownerPhone) {
  const { actor } = useActor();
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async ({
      ...
      if (!actor) throw new Error("Backend se connection nahi। पेज reload करें।");
      return actor.updateSalonLocation(
        ownerPhone,
        passwordHash,
        lat,
        lng
    ...
    onSuccess: () => qc.invalidateQueries({ queryKey: ["mySalon", ownerPhone] })
  });
}
...
export {
  useSaveCustomerProfile as $,
  useAdminSetSalonTrialDays as A,
  Badge as B,
  Card as C,
  useAdminApproveSubRequest as D,
  useAdminRejectSubRequest as E,
  ...
  useFocusGuards as M,
  FocusScope as N,
  DismissableLayer as O,
  Presence as P,
  createSlot as Q,
  ReactRemoveScroll as R,
  createContext2 as S,
  useGetMyCustomerProfile as T,
  useSavePushSubscription as U,
  LogOut as V,
  Tabs as W,
  X,
  TabsList as Y,
  ...
  useGetAllActiveSalons as a0,
  Navigation as a1,
  useGetMyAppointments as a2,
  useGetSalonServices as a3,
  useGetSalonClosedDays as a4,
  useBookAppointment as a5,
  useGetQueueInfo as a6,
  useGetSalonPhotos as a7,
  useLayoutEffect2 as a8,
  useCallbackRef$1 as a9,
  useDirection as aa,
  createCollection as ab,
  useGetCurrentServiceSession as ac,
  useGetQueueScheduleForSalon as ad,
  useGetPendingNotifications as ae,
  useStartServiceSession as af,
  useClearServiceSession as ag,
  useMarkNotificationSent as ah,
  useGetPlanPricings as ai,
  useSubmitSubscriptionRequest as aj,
  useGetMySalon as ak,
  useGetSalonAppointmentsForDate as al,
  useGetOwnerRevenueSummary as am,
  useUpdateAppointmentStatus as an,
  useAddSalonService as ao,
  useDeleteSalonService as ap,
  useUpdateMySalon as aq,
  useUpdateSalonLocation as ar,
  useGetMySubHistory as as,
  useUploadSalonPhoto as at,
  useDeleteSalonPhoto as au,
  useSetSalonClosedDays as av,
  useAdminGetAllSalons as b,
  useAdminGetDefaultTrialDays as c,
  useAdminGetSubscriptionPrice as d,
  useAdminGetPendingSubRequests as e,
  useAdminApproveSalon as f,
  useAdminRejectSalon as g,
  useAdminSetSalonActive as h,
  useAdminSetSalonSubscription as i,
  useAdminSetDefaultTrialDays as j,
  useAdminSetSubscriptionPrice as k,
  useAdminProcessTrialExpirations as l,
  useAdminGetRevenueStats as m,
  CardContent as n,
  CardHeader as o,
  CardTitle as p,
  useAdminResetOwnerPassword as q,
  useAdminGetAllPlanPricings as r,
  useAdminSetPlanPricing as s,
  useAdminGetSubRequestEarnings as t,
  useAdminGetDashboardStats as u,
  useAdminBackup as v,
  useAdminRestore as w,
  useAdminGetAllSubRequests as x,
  useAdminGetSubHistory as y,
  useAdminExpireOldSubRequests as z
};
