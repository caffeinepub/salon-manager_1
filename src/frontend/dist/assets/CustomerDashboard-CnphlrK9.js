import { c as createLucideIcon, j as jsxRuntimeExports, S as Slot$1, a as cn, b as cva, r as reactExports, u as useComposedRefs, P as Primitive, d as dispatchDiscreteCustomEvent, R as ReactDOM, e as createSlot, f as useActor, L as LoaderCircle, g as Scissors, B as Button, E as ErrorBoundary, h as Label, I as Input, i as Phone, k as ue } from "./index-B9yPYncm.js";
import { p as useCallbackRef$1, q as composeEventHandlers, r as useLayoutEffect2, s as useControllableState, t as createContextScope, v as useId, P as Presence, w as createContext2, x as useGetMyCustomerProfile, L as LogOut, T as Tabs, y as TabsList, z as TabsTrigger, A as TabsContent, B as useSaveCustomerProfile, C as Card, n as CardHeader, o as CardTitle, m as CardContent, D as useGetAllActiveSalons, E as useGetMyAppointments, F as useGetSalonServices, G as useBookAppointment, H as CircleCheckBig, I as useGetQueueInfo, J as Clock } from "./tabs-BjibxdOt.js";
/**
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4 text-center p-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "oklch(0.75 0.05 145)" }, children: "प्रोफ़ाइल लोड हो रही है..." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "max-w-2xl mx-auto p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "salons", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "salons", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SalonListTab, { phone, profile: effectiveProfile }) }) }),
    ...
    DialogContent,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { style: { color: "oklch(0.95 0.02 145)" }, children: "रेटिंग दें" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "oklch(0.6 0.05 145)" }, children: salonName })
        ] }),
              ...
              "button",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Star,
                  {
                    className: "w-8 h-8",
                    style: {
                      color: n <= (hovered || stars) ? "oklch(0.82 0.18 85)" : "oklch(0.35 0.04 155)",
                      fill: n <= (hovered || stars) ? "oklch(0.82 0.18 85)" : "transparent",
...
function SalonListTab({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    ...
    salons.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12", "data-ocid": "salons.empty_state", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "oklch(0.6 0.05 145)" }, children: "अभी कोई सैलून उपलब्ध नहीं" })
    ] }) : salons.map((salon, idx) => {
      const { avg, count: count2 } = getAverageRating(salon.id.toString());
      const isTopRated = avg >= 4.5 && count2 >= 1;
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                count2 > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 mt-0.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: "text-xs",
...
function BookingModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { style: { color: "oklch(0.95 0.02 145)" }, children: salon.name }) }),
        booked ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", style: { color: "oklch(0.6 0.05 145)" }, children: [
            "आपकी अपॉइंटमेंट ",
            date,
            " को है"
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            ) }) : services.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "oklch(0.6 0.05 145)" }, children: "इस सैलून में कोई सेवा नहीं है अभी" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: services.map((svc) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                ...
                style: {
                  background: selectedService === svc.name ? "oklch(0.52 0.18 145 / 0.2)" : "oklch(0.22 0.05 155)",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2 mb-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Badge,
              {
                className: "text-xs",
                style: {
                  background: appt.status === "completed" ? "oklch(0.52 0.18 145 / 0.2)" : appt.status === "cancelled" ? "oklch(0.577 0.245 27.325 / 0.2)" : "oklch(0.75 0.12 70 / 0.2)",
                  color: appt.status === "completed" ? "oklch(0.52 0.18 145)" : appt.status === "cancelled" ? "oklch(0.577 0.245 27.325)" : "oklch(0.75 0.12 70)",
                  border: "none"
                },
          ...
          isActive && queueInfo && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", style: { color: "oklch(0.75 0.1 145)" }, children: [
                  "आप नंबर ",
          ...
          appt.status === "completed" && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: alreadyRated ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "oklch(0.52 0.18 145)" }, children: "✓ रेटिंग दी गई" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  size: "sm",
                  variant: "ghost",
...
function MyBookingsTab({ phone }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    ...
    sorted.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12", "data-ocid": "bookings.empty_state", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "oklch(0.6 0.05 145)" }, children: "कोई बुकिंग नहीं है" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1", style: { color: "oklch(0.45 0.04 155)" }, children: '"सैलून चुनें" टैब से बुक करें' })
...
const CustomerDashboard$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
