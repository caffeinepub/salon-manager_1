...
import { m as Subscribable, s as shallowEqualObjects, n as hashKey, o as getDefaultState, p as notifyManager, q as useQueryClient, r as reactExports, t as noop, v as shouldThrowError, c as createLucideIcon, j as jsxRuntimeExports, a as cn, g as useActor, w as useQuery, u as ue, x as React, d as useComposedRefs, y as React2, f as createSlot, P as Primitive } from "./index-8-_B2D1Y.js";
...
function useRegisterSalon(phone) {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      return resolvedActor.registerSalonByPhone(
        phone,
        name,
        address,
        salonPhone,
