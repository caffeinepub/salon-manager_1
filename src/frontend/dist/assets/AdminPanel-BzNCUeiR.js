import { r as reactExports, j as jsxRuntimeExports, B as Button, I as Input, u as ue } from "./index-ByyGmaiP.js";
import { u as useAdminGetDashboardStats, a as useAdminGetPendingSalons, b as useAdminGetAllSalons, c as useAdminGetDefaultTrialDays, d as useAdminGetSubscriptionPrice, e as useAdminApproveSalon, f as useAdminRejectSalon, g as useAdminSetSalonActive, h as useAdminSetSalonSubscription, i as useAdminSetDefaultTrialDays, j as useAdminSetSubscriptionPrice, k as useAdminProcessTrialExpirations, l as useAdminGetRevenueStats, C as Card, m as CardContent, n as CardHeader, o as CardTitle, p as useAdminResetOwnerPassword, B as Badge, q as useAdminBackup, r as useAdminRestore } from "./tabs-BQ8B1Vo5.js";
import { getRatings, deleteRating } from "./CustomerDashboard-Dip80HiN.js";
...
function SubscriptionRequestsTab({
  ...
  const handleReject = (req) => {
    ...
    localStorage.setItem("salon360_sub_requests", JSON.stringify(updated));
    setRequests(updated);
    ue.success(`${req.salonName} का अनुरोध अस्वीकृत किया गया`);
  };
  ...
  if (pending.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "p",
      {
        ...
        children: "कोई लंबित अनुरोध नहीं है।"
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", "data-ocid": "sub_requests.list", children: pending.map((req, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    Card,
    {
      className: "border",
      "data-ocid": `sub_requests.item.${idx + 1}`,
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-4 space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: req.salonName }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-400", children: [
              "अनुरोध: ",
              new Date(req.requestTime).toLocaleString("hi-IN")
            ] })
          ] }),
...
function BackupTab() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-red-600 font-medium", children: "⚠️ सावधान: रिस्टोर करने पर मौजूदा सारा डेटा हट जाएगा और बैकअप फ़ाइल का डेटा आ जाएगा।" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600", children: "पहले से डाउनलोड की गई JSON बैकअप फ़ाइल चुनें।" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ref: fileInputRef,
        ...
        restoreMutation.isPending && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            className: "text-xs text-gray-500 text-center",
            "data-ocid": "backup.loading_state",
            children: "डेटा रिस्टोर हो रहा है..."
          }
        )
      ] })
    ] })
