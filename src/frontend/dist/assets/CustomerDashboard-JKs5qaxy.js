...
function CustomerDashboard({ phone, onSwitchRole }) {
  ...
  if (profileLoading && !loadTimedOut && !profileSaved) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(SalonLoadingScreen, {});
  }
  ...
  if (!effectiveProfile) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(SalonLoadingScreen, { message: "प्रोफ़ाइल लोड हो रही है..." });
  }
