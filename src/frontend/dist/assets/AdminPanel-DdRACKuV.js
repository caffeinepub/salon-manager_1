    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 max-w-2xl mx-auto space-y-4", children: [
      ...
      tab === "settings" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm", children: "सदस्यता मूल्य (₹/माह)" }) }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  children: setPriceMutation.isPending ? "..." : "सेव करें"
                }
              )
            ] }),
            setPriceMutation.isSuccess && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-green-600", children: "✓ मूल्य अपडेट हो गया — अब हर जगह नया मूल्य दिखेगा" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400", children: "मूल्य बदलने के बाद नई सदस्यताओं पर तुरंत लागू होगा।" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
