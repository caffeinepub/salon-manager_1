...
import { n as Subscribable, s as shallowEqualObjects, o as hashKey, p as getDefaultState, q as notifyManager, t as useQueryClient, r as reactExports, v as noop, w as shouldThrowError, c as createLucideIcon, j as jsxRuntimeExports, x as Slot, d as cn, y as cva, e as useActor, z as useQuery, u as ue, A as React, a as useComposedRefs, P as Primitive, C as dispatchDiscreteCustomEvent, D as ReactDOM, R as React2, b as createSlot } from "./index-CKojsgvc.js";
...
function useAdminGetAllSubRequests() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (!actor) throw new Error("Backend se connection nahi");
      return actor.adminGetAllSubRequests();
    },
    enabled: !!actor && !isFetching,
    refetchInterval: 1e4
  });
...
function useAdminApproveSubRequest() {
  ...
  return useMutation({
    mutationFn: async (requestId) => {
      if (!actor) throw new Error("No actor");
      return actor.adminApproveSubRequest(requestId);
    },
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["adminPendingSubRequests"] });
...
function useAdminRejectSubRequest() {
  ...
  return useMutation({
    mutationFn: async (requestId) => {
      if (!actor) throw new Error("No actor");
      return actor.adminRejectSubRequest(requestId);
    },
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["adminPendingSubRequests"] });
      qc.invalidateQueries({ queryKey: ["adminAllSubRequests"] });
...
export {
  ...
  TabsTrigger as W,
  TabsContent as X,
  useSaveCustomerProfile as Y,
  useGetAllActiveSalons as Z,
  useGetMyAppointments as _,
  useAdminGetPendingSalons as a,
  useBookAppointment as a0,
  useGetQueueInfo as a1,
  useLayoutEffect2 as a2,
  useCallbackRef$1 as a3,
  useDirection as a4,
  createCollection as a5,
  useGetCurrentServiceSession as a6,
  useGetQueueScheduleForSalon as a7,
  useGetPendingNotifications as a8,
  useStartServiceSession as a9,
  useClearServiceSession as aa,
  useMarkNotificationSent as ab,
  useGetPlanPricings as ac,
  useSubmitSubscriptionRequest as ad,
  useGetMySalon as ae,
  useGetSalonAppointmentsForDate as af,
  useGetOwnerRevenueSummary as ag,
  useUpdateAppointmentStatus as ah,
  useAddSalonService as ai,
  useDeleteSalonService as aj,
  useUpdateMySalon as ak,
  useGetMySubHistory as al,
