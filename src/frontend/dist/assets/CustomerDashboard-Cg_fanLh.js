...
function CustomerDashboard({ phone, onSwitchRole }) {
  ...
  if (!profile) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ProfileSetupForm, { phone, onLogout: onSwitchRole });
  }
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "max-w-2xl mx-auto p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "salons", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "salons", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SalonListTab, { phone, profile }) }) }),
...
function ProfileSetupForm({
  ...
  const handleSubmit = (e) => {
    ...
    mutate(
      { name: name.trim() },
      {
        onSuccess: () => ue.success("प्रोफ़ाइल सेव हो गई!"),
